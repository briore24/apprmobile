...
public class EUOWOOPPAnalogDatasheetTests extends AnalogDatasheetTests {
	...
	public void setup(String configPath) throws Exception {
		super.setup(
			configPath,
			DatasheetConstants.MODEL_EUOWOOPP
		);
	}
	...
	//Express in maximum resolution actually entered for Input or Output, Truncate OFF

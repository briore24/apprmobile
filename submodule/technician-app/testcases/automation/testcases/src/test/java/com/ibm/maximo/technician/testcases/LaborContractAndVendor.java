...
/*
* MASR-796 Technician (RBA) - Report Work - Labor, the selection of the craft should show craft, skilllevel, vendor and contract
 */
public class LaborContractAndVendor extends TechnicianTest {
	private final Logger logger = LoggerFactory.getLogger(LaborContractAndVendor.class);
	private AbstractAutomationFramework af;
	private TestSuite testSuite;
	private MaximoApi maximoApi;
	private String woNum, timezone, labor, header, reportHeader, contractId="4999", vendor, masServer;
	private WorkOrder newWorkOrder;
	private String laborHeaderText = "Labor";
	private String laborName, craft, craftDescription, skill, laborType1;
	...
	public void setup(String configPath) throws Exception {
		logger.info("********************LaborContractAndVendor*********************************");
		...
		try {
			...
			if (masServer.equals("false")) {
				...
				craftDescription = "Mobile Automation Craft";
				laborType1 = "Waiting for materials";
			}
	...
	public void checkLaborContractAndVendorDetails() throws Exception {
		...
		logger.info("Craft on edit labor drawer: " + craftDescription);
		assertEquals(craftDescription, reportWork.getLaborCraftOnDrawer());
		logger.info("Skill level on edit labor drawer: " + skill);
		assertEquals(skill, reportWork.getLaborSkillOnDrawer());
		logger.info("Vendor on edit labor drawer: " + vendor);
		assertEquals(vendor, reportWork.getLaborVendorOnDrawer());
		logger.info("Vendor on edit labor drawer: " + contractId);
		assertEquals(contractId, reportWork.getLaborContractOnDrawer());	
	...
	public void laborContractVendorRelationShips() {
		String insertQuery = "INSERT INTO MAXIMO.CONTRACT (CONTRACTNUM, DESCRIPTION, MASTERNUM, VENDORREFNUM, CONTRACTTYPE, REVISIONNUM, PURCHASEAGENT, STATUS, STATUSDATE, STARTDATE, ENDDATE, RENEWALDATE, EXTENDABLE, AUTOEXTENDPERIOD, CONDFOREXT, CUSTTERMALLOWED, CUSTNOTIFYPERIOD, VENDTERMALLOWED, VENDNOTIFYPERIOD, VENDOR, CONTACT, FREIGHTTERMS, PAYMENTTERMS, SHIPVIA, CUSTOMERNUM, FOB, TOTALCOST, CHANGEBY, CHANGEDATE, HISTORYFLAG, CURRENCYCODE, EXCHANGERATE, EXCHANGERATE2, EXCHANGEDATE, BUYAHEAD, INCLUSIVE1, INCLUSIVE2, INCLUSIVE3, INCLUSIVE4, INCLUSIVE5, EXTERNALREFID, OWNERSYSID, SENDERSYSID, ORGID, TOTALBASECOST, POREQUIRED, PAYMENTSCHED, HASINSURANCE, INSURANCEEXPDATE, CONTRACTID, REVCOMMENTS, LANGCODE, MASTERREVNUM, PROCESSCLAIM, INSPECTIONREQUIRED, HASLD, ROWSTAMP)"
				+ " VALUES('"+contractId+"', 'TEST', NULL, NULL, 'LABOR', 0, NULL, 'DRAFT', TIMESTAMP '2025-02-01 04:27:55.000000', TIMESTAMP '2025-02-01 00:00:00.000000', NULL, NULL, 0, NULL, NULL, 1, NULL, 1, NULL, '"+vendor+"', 'GERRY DENNING', NULL, '2/10 NET 30', 'UPS-GR', '6461066', 'MORLEY, CO', 0, '"+ labor +"', TIMESTAMP '2025-02-01 04:28:43.000000', 0, '"+ SetupData.CURRENCYCODE +"', NULL, NULL, NULL, 0, 1, 0, 0, 0, 0, NULL, NULL, NULL, '"+ SetupData.ORGID +"', 0, 0, 0, 0, NULL, 248, NULL, 'EN', NULL, 0, 0, 0, '1552175')";

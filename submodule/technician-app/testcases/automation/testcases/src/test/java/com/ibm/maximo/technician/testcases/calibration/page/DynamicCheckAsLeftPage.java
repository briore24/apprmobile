...
public class DynamicCheckAsLeftPage {

	private AbstractAutomationFramework af;
	JavascriptExecutor jsExec;
	private final static Logger logger = LoggerFactory.getLogger(DynamicCheckAsLeftPage.class);
	public static String dynamicCheckAsLeftPageTitle = "As left values";
	...
	private String dynamicCheckPointkName = ".//p[@id='zvee_[%s]']";
	private String valueInputFields = ".//input[contains(@id,'rzznx')]";
	private String valueInput = "(.//li)[%s]//input[contains(@id,'rzznx')]";
	private String unitInput = "(.//li)[%s]//input[contains(@id,'qww4q') and contains(@id, '_lookup_buttongroup')]";
	private String unitSearchBtn = "(.//li)[%s]//button[contains(@id,'qww4q') and contains(@id, '_actionbuttongroup_dydz8')]";
	private String dynamicCheckSaveBtn = "xq88g-pageheader_buttongroup_wq_wk";
	

	public DynamicCheckAsLeftPage(AbstractAutomationFramework af) {
		this.af = af;
	}
	...
	public String getDynamicCheckPointName(int dynamciCheckPointIndex) throws Exception {
		return af.waitForElementToBePresent(By.xpath(dynamicCheckPointkName.replace("%s", String.valueOf(dynamciCheckPointIndex)))).getText().trim();
	}
	...
	public String getValueInput(int index) throws Exception {
		return af.waitForElementToBePresent(By.xpath(valueInput.replace("%s", String.valueOf(index + 1)))).getAttribute("value").toString();
	}
	...
	public String getUnitInput(int index) throws Exception {
		return af.waitForElementToBePresent(By.xpath(unitInput.replace("%s", String.valueOf(index + 1)))).getAttribute("value").toString();
	}
	...
	public void enterValueAndSelectUnit() throws Exception {
		...
		System.setProperty("AsLeftDynamicCheckSelectedValue", selectedValues.replace("null", ""));
	}
	...
	public void verifySavedValues() throws Exception {
		List<WebElement> valueInputEle = (List<WebElement>) af.getDriver().findElements(By.xpath(valueInputFields));
		String selectedValues = System.getProperty("AsLeftDynamicCheckSelectedValue");
		for (int i = 0; i < valueInputEle.size(); i++) {

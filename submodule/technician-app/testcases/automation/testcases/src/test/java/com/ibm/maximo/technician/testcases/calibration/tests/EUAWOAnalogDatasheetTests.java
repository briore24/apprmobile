...
public class EUAWOAnalogDatasheetTests extends AnalogDatasheetTests {
	...
	public void setup(String configPath) throws Exception {
		super.setup(
			configPath,
			DatasheetConstants.MODEL_EUAWO
		);
	}
	...
	//Express in maximum resolution actually entered for Input or Output, Truncate ON

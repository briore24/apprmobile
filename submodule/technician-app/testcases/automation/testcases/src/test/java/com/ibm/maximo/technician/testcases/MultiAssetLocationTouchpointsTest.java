...
/*
 * MASR-1317:Technician (RBA) - Review MultiAsset details and related touchpoints
...
public class MultiAssetLocationTouchpointsTest extends TechnicianTest {
	private final Logger logger = LoggerFactory.getLogger(MultiAssetLocationTouchpointsTest.class);
	...
	public void setup(String configPath) throws Exception {
		logger.info("********************MultiAssetLocationTouchpointsTest*********************************");
	...
	@Test(groups = { "mobile" , "desktop"}, description = "Verify Multiple touch points on Multiple Assets and locations page", timeOut = 800000)
	public void WorkOrderWithMultiAssetLocation() throws Exception {
		...
		Thread.sleep(5000);
		// Make sure it is back to Multiple assets and locations page
		assertEquals(multiALpage.getTextMultipleAssetsAndLocations(),
				"Multiple assets and locations");
		logger.info("Navigation back to Multiple assets and locations page in Technician app done correctly.");
		
		// assetNum3 is search and when click on chevron of Asset then we nagivate to asset app 
		// assetNum 3 had Inspection form
		multiALpage.search(assetNum3);
	...
	@Test(groups = { "priority2" , "desktop"}, description = "Verify followup work order in multiAssetlocationCi", timeOut = 800000)
	public void WorkOrderWithMultiAssetLocationFollowUp() throws Exception {
		...
		Thread.sleep(4000);
		// Verify user is navigated back to Multiasset list
		assertEquals(multiALpage.getTextMultipleAssetsAndLocations(),
				"Multiple assets and locations");
		
		multiALpage.clickBackChevron();
		// MAXMOA-8669, MAXMOA-8379 Open bugs. Will uncomment and re-run once issues resolved
		...
		//assertEquals("WORKORDER_DESCRIPTION", followUpWorkPage.followUpDescription());
